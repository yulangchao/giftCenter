...
export default {
    ...
    return {
      ...
      mescrollUp: {
        ...
        empty: {
          ...
          icon: "https://orig00.deviantart.net/23ac/f/2016/137/4/9/chibi_singed_sd_by_kairui_chan-da2umnu.png", // 图标,支持网络图
          tip: "暂无相关数据~", // 提示
          btntext: "去逛逛 >", // 按钮,默认""
          btnClick() {
            // 点击按钮的回调,默认null
  ...
  methods: {
    ...
    // 选中状态的样式
    getActiveCls(type) {
      return this.pdType === type ? "tab-nav-item tab-active" : "tab-nav-item";
    },
    // 切换菜单
    changeTab(type) {
      if (this.pdType !== type) {
